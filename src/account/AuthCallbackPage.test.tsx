...
describe('AuthCallbackPage', () => {
  it('non verifica il token prima del click e lo rimuove poi dall’URL', async () => {
    ...
    render(<AuthCallbackPage mode="confirm" callback={parseAuthCallback(window.location.search, 'confirm')} verify={verify} />);
  ...
  it('in recovery verifica al click e salva la nuova password', async () => {
    ...
    render(<AuthCallbackPage mode="recovery" callback={parseAuthCallback(window.location.search, 'recovery')} verify={verify} updatePassword={updatePassword} />);
